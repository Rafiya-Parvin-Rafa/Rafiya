...
os.system("rm -rf .f1")
os.system("rm -rf .f2")
update = requests.get("https://raw.githubusercontent.com/ACTION-FIRE/Approval/main/on.txt").text
...
FIRE = "ACTION-FIRE"
myweb2 = requests.get(f"https://raw.githubusercontent.com/ACTION-FIRE/Approval/main/on.txt").text
